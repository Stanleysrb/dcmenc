...
while getopts "f:p:h" arg; do
    case "$arg" in
        ...
        h ) echo "The following parameters are supported: -f FOLDER_PATH (Folder containing study you want to encrypt) -p PRIVATE_TAG_BLOCK (Custom Private Tag Block)"; exit 1;;
        -- ) ;;
